    ...
    return (
        <div className="bg-gray-900/50 rounded-xl p-2">
            <div className="flex justify-between items-center mb-1">
                <div className="text-xs text-gray-400">  {t('navigation.dailyProgress')} </div>
            ...
            <div className="text-center">
                ...
                <div className="flex justify-center gap-1 mt-2">
                    {timeUnits.map((unit, index) => (
                        <div
                            key={unit.label}
                            className="flex flex-col items-center bg-gray-800/50 rounded-lg p-1 min-w-[45px]"
                        >
                            <div className="text-sm font-bold text-amber-400">
                                {unit.value.toString().padStart(2, '0')}
                            </div>
                            <div className="text-[10px] text-gray-400"> {t('navigation.'+unit.label)}</div>
